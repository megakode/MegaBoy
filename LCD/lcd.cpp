...
{
    static uint8_t window_internal_line_counter = 0;
...
*/
    ...
    // TODO: try to change when the drawing below occurs. In a different mode maybe. Also try to move the stat irq firings around.
    // The empty line after the window is hidden and right before it is shown again might have something to do with this, as the code disableing it might listen to the stat irqs
