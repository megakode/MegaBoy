...
#ifndef MEGABOY_CARTRIDGEHEADER_H
#define MEGABOY_CARTRIDGEHEADER_H
...
std::map<int,std::string> CartridgeTypeNames = {
        {ROM_Only,"ROM"},
        {MBC1,"MBC1"},
        {MBC1_RAM,"MBC1 + RAM"},
...
struct CartridgeHeader {
    ...
    [[nodiscard]] uint32_t ROMSizeInBytes() const {
        return (32*1024) << ROMSize;
    }

};

#endif //MEGABOY_CARTRIDGEHEADER_H
